...
public:
	...
	bool operator==(const ZavrsniRad& obj) {
		return strcmp(obj._tema, _tema) == 0;
	}
	~ZavrsniRad() {
	...
	void SetKonacnaOcjena(int ocjena) {_konacnaOcjena = ocjena;}
...
public:
	...
	bool DodajZavrsniRad(string indeks, ZavrsniRad zavrsni) {
